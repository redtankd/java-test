...
public class ClassModifierDemo
{
	...
	InputStream in = ASMHelloWorld.class
		.getResourceAsStream("/org/redtank/asm/ClassModificationDemo.class");
	...
	File outputDir = new File("bin/org/redtank/asm");
	outputDir.mkdirs();
	DataOutputStream dout = new DataOutputStream(new FileOutputStream(
		new File(outputDir, "ClassModificationDemo.class")));
